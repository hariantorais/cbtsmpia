...
/*---------------------------------------------------------------
  SQL DB BACKUP 04.09.2022 10:24 
  HOST: localhost
  DATABASE: cbt
  TABLES: *
  ---------------------------------------------------------------*/
...
INSERT INTO `jenis` VALUES   ('PAS','Penilaian Akhir Semester','aktif');
...
INSERT INTO `pengawas` VALUES   ('1','-','HARIANTO','','admin@admin.com','$2y$10$epNnW2Ki0/xp/Xwi1iCaduDWK5BCQ0.bKWXqnDtmDr/dI9sLUiKRy','admin','','','0000-00-00','','','','','','','','','','0','','','','','','','','','','','','','','0000-00-00','','','','',NULL,NULL,NULL);
